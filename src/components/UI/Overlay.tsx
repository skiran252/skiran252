      ...
      <Section className="items-start">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-2xl leading-relaxed font-light">
            ...
            I'm an engineer obsessed with the intersection of <span className="text-cyan-400">Backend Systems</span> and <span className="text-purple-400">Artificial Intelligence</span>.
          </p>
        </motion.div>
      </Section>
